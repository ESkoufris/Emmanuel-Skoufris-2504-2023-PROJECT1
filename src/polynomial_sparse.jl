...
#= cyclotonic_polynomialsparse128(p::Int) = PolynomialSparse128([Term(1,p), Term(-1,0)]) =#

"""
Construct a polynomial of the form x-n.
"""
linear_monic_polynomialsparse(n::Int) = PolynomialSparse([Term(1,1), Term(-n,0)])
#= linear_monic_polynomialsparse128(n::Int) = PolynomialSparse([Term(1,1), Term(-n,0)]) =#

"""
Construct a polynomial of the form x.
"""
x_polysparse() = PolynomialSparse(Term(1,1))
#= x_polysparse128() = PolynomialSparse(Term(1,1)) =#
...
"""
÷(p::PolynomialSparse, n::Int) = (prime) -> PolynomialSparse([(term ÷ n)(prime) for term in p.terms])
...
struct PolynomialSparse128
    ...
    function PolynomialSparse128(vt::Vector{Term})
        ...
        for t in vt
            if haskey(dict, t.degree)
               delete_element!(terms, dict, t.degree)
               insert_sorted!(terms, dict, Int128(t.degree), Term128(t)) 
            else 
                insert_sorted!(terms, dict, Int128(t.degree), Term128(t))
            end
        end
...
Construct a polynomial of the form x-n.
"""
linear_monic_polynomialsparse128(n::Int) = PolynomialSparse128([Term(1,1), Term(-n,0)])


"""
Construct a polynomial of the form x.
"""
x_polysparse128() = PolynomialSparse128(Term(1,1))
...
The negative of a polynomial.
"""
-(p::PolynomialSparse128) = PolynomialSparse128([-t for t in p.terms])
...
function *(t::Term, p::PolynomialSparse128)::PolynomialSparse128 
...
"""
Power of a polynomial modulo a prime number.
"""
function pow_mod(p::PolynomialSparse128, n::Int, prime::Int)
    return (PolynomialModP128(p, prime)^n).polynomial
end
