...
# and so division of the nonzero coefficients is well defined .
(q ÷ p)(7)


# finding the gcd of two polynomials modulo 7. We are reducing the coeffcients of the polynomials modulo 7 and then looking 
